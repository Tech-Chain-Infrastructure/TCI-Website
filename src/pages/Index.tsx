...
import { Book, BarChart3, ShoppingBag, Atom, Star, Award, Clock, CheckCircle } from 'lucide-react';
  ...
  const keyFeatures = [
    {
      id: 1,
      title: "Bridging Gaps",
      description: "Connect consumers with sellers through our intuitive platform, facilitating seamless transactions and partnerships."
    },
    {
      id: 2,
      title: "Educational Outreach",
      description: "Access comprehensive educational resources and programs designed to foster growth and learning."
    },
    {
      id: 3,
      title: "Financial Solutions",
      description: "Leverage our Fin-Tech services for secure, efficient transaction processing and financial management."
    },
    {
      id: 4,
      title: "Development Services",
      description: "Utilize our expertise in app and website development to bring your digital vision to life."
    },
    {
      id: 5,
      title: "Secure Transactions",
      description: "Benefit from our advanced encryption and security protocols that ensure safe data handling."
    },
    {
      id: 6,
      title: "24/7 Availability",
      description: "Access our platform anytime, anywhere with our commitment to round-the-clock service availability."
    }
  ];
  ...
  return (
    <Layout>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <h2 className="text-center text-3xl font-bold mb-12">Why Choose TCI</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6">
              <div className="bg-tci-primary/10 p-4 rounded-full mb-4">
                <Award size={32} className="text-tci-primary" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Top-Rated Solutions</h3>
              <p className="text-gray-600">Our technology solutions consistently receive top ratings from industry experts and clients alike.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <div className="bg-tci-primary/10 p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600">Each solution is thoroughly evaluated and reviewed by our team of technology experts.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6">
              <div className="bg-tci-primary/10 p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600">We continuously update our reviews and solutions to reflect the latest technology advancements.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-tci-dark text-white py-20 relative overflow-hidden">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-lg max-w-2xl mx-auto mb-8">
            Connect with our team to explore how TCI can help you achieve your goals through our cutting-edge technology solutions.
          </p>
          <a 
            href="/contact" 
